...
class Admin::CategoriesControllerTest < ActionController::TestCase
  ...
  test "should create admin_category" do
    assert_difference('Admin::Category.count') do
      post :create, admin_category: { active: @admin_category.active, description: @admin_category.description, name: @admin_category.name, ordem: @admin_category.ordem, published: @admin_category.published }
    end
  ...
  test "should update admin_category" do
    patch :update, id: @admin_category, admin_category: { active: @admin_category.active, description: @admin_category.description, name: @admin_category.name, ordem: @admin_category.ordem, published: @admin_category.published }
    assert_redirected_to admin_category_path(assigns(:admin_category))
  end
