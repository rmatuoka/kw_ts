class UsersController < ApplicationController
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:password, :password_confirmation, :email, :name, :role, :last_name, :birthdate, :company, :services_performed, :cep, :street, :number, :neighborhood, :city, :state, :picture)
    end
end
